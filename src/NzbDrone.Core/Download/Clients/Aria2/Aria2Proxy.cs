...
namespace NzbDrone.Core.Download.Clients.Aria2
{
    ...
    {
        private readonly ILogger<Aria2Proxy> _logger;

        public Aria2Proxy(ILogger<Aria2Proxy> logger)
        {
            _logger = logger;
        }
        ...
        {
            _logger.LogTrace("> aria2.getVersion");
        ...
        {
            _logger.LogTrace("> aria2.tellStatus");
        ...
        {
            _logger.LogTrace("> aria2.tellActive");
        ...
        {
            _logger.LogTrace("> aria2.getGlobalOption");
        ...
        {
            _logger.LogTrace("> aria2.addTorrent");
        ...
        {
            _logger.LogTrace("> aria2.forceRemove");
        ...
        {
            _logger.LogTrace("> aria2.removeDownloadResult");
