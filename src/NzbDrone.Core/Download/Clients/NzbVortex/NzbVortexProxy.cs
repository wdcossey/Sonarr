...
using Newtonsoft.Json; //TODO Remove Newtonsoft.Json
...
namespace NzbDrone.Core.Download.Clients.NzbVortex
{
    ...
    public class NzbVortexProxy : INzbVortexProxy
    {
        ...
        public NzbVortexProxy(IHttpClient<NzbVortexProxy> httpClient, ICacheManager cacheManager, ILogger<NzbVortexProxy> logger)
        {
