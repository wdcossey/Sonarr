...
namespace Sonarr.Http.Filters
{
    /// <summary>
    /// Makes sense of the <see cref="PagingResource"/> filters from the <see cref="ActionExecutingContext"/>
    /// </summary>
    public class SonarrPagingResourceFilterAttribute : Attribute, IActionFilter
    {
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            foreach (var (queryKey, queryValues) in context.HttpContext.Request.Query.Where(w => !EXCLUDED_KEYS.Contains(w.Key)))
            {
